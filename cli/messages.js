...
walk(process.env.TGENPATH + '../plugins/messages/'); // entry point that will be used by plugin to make custom messages for tgen

exports.logMessages = {};

exports.newMessageType = msgType => (msg, id) => {
  return exports.logMessages[msgType] ? exports.logMessages[msgType][id] ? exports.logMessages[msgType][id] : msg : msg;
};
